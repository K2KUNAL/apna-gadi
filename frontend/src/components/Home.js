...
import "./Home.css";
import AGlogo from "./images/AGlogo.png"; // Importing logo properly
const Home = () => {
...
<section className="about-apna-gadi">
              <h2>
              ...
              <p>
                ...
                <strong>affordable, convenient, and eco-friendly</strong>.
                Whether it's your <strong>daily commute</strong>, a{" "}
                <strong>weekend getaway</strong>, or a{" "}
                <strong>business trip</strong>, we ensure a seamless,
              ...
              <p>
                ...
                <strong>
                  {" "}
                  students, professionals, and residents
                </strong> with <strong>sustainable transport solutions</strong>.
                Our mission? To make{" "}
                <strong>green mobility accessible to all</strong> while keeping
